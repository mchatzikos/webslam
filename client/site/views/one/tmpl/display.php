	...
	<div class="main section">
		<div class="subject">
			...
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-xs-2" for="optimized" title="Can improve query execution time by up to 7x for searches with many observables">Optimize query for time?</label>
			...
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-xs-2" for="Ratio">Hardness ratio (hard / broad)</label>
			...
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-xs-2" for="P1P0_pk">Power ratio ord=1 about peak</label>
				...
				<div class="form-group">
					<label class="control-label col-xs-2" for="P2P0_R500C">P2/P0 ratio w/in 1.0 R500, core included</label>
					<input type="text" size="12" maxlength="12" id="P2P0_R500C" name="P2P0_R500C"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P3P0_R500C">P3/P0 ratio w/in 1.0 R500, core included</label>
					<input type="text" size="12" maxlength="12" id="P3P0_R500C" name="P3P0_R500C"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P4P0_R500C">P4/P0 ratio w/in 1.0 R500, core included</label>
					<input type="text" size="12" maxlength="12" id="P4P0_R500C" name="P4P0_R500C"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P2P0_1C">P2/P0 ratio w/in  500.0 kpc, core included</label>
					<input type="text" size="12" maxlength="12" id="P2P0_1C" name="P2P0_1C"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P3P0_1C">P3/P0 ratio w/in  500.0 kpc, core included</label>
					<input type="text" size="12" maxlength="12" id="P3P0_1C" name="P3P0_1C"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P4P0_1C">P4/P0 ratio w/in  500.0 kpc, core included</label>
					<input type="text" size="12" maxlength="12" id="P4P0_1C" name="P4P0_1C"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P2P0_2C">P2/P0 ratio w/in 1000.0 kpc, core included</label>
					<input type="text" size="12" maxlength="12" id="P2P0_2C" name="P2P0_2C"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P3P0_2C">P3/P0 ratio w/in 1000.0 kpc, core included</label>
					<input type="text" size="12" maxlength="12" id="P3P0_2C" name="P3P0_2C"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P4P0_2C">P4/P0 ratio w/in 1000.0 kpc, core included</label>
					<input type="text" size="12" maxlength="12" id="P4P0_2C" name="P4P0_2C"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P2P0_R500E">P2/P0 ratio w/in (0.05--1.0) R500</label>
					<input type="text" size="12" maxlength="12" id="P2P0_R500E" name="P2P0_R500E"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P3P0_R500E">P3/P0 ratio w/in (0.05--1.0) R500</label>
					<input type="text" size="12" maxlength="12" id="P3P0_R500E" name="P3P0_R500E"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P4P0_R500E">P4/P0 ratio w/in (0.05--1.0) R500</label>
					<input type="text" size="12" maxlength="12" id="P4P0_R500E" name="P4P0_R500E"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P2P0_1E">P2/P0 ratio w/in (  30.0-- 500.0) kpc</label>
					<input type="text" size="12" maxlength="12" id="P2P0_1E" name="P2P0_1E"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P3P0_1E">P3/P0 ratio w/in (  30.0-- 500.0) kpc</label>
					<input type="text" size="12" maxlength="12" id="P3P0_1E" name="P3P0_1E"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P4P0_1E">P4/P0 ratio w/in (  30.0-- 500.0) kpc</label>
					<input type="text" size="12" maxlength="12" id="P4P0_1E" name="P4P0_1E"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P2P0_2E">P2/P0 ratio w/in (  30.0--1000.0) kpc</label>
					<input type="text" size="12" maxlength="12" id="P2P0_2E" name="P2P0_2E"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P3P0_2E">P3/P0 ratio w/in (  30.0--1000.0) kpc</label>
					<input type="text" size="12" maxlength="12" id="P3P0_2E" name="P3P0_2E"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="P4P0_2E">P4/P0 ratio w/in (  30.0--1000.0) kpc</label>
				...
				<div class="form-group">
					<label class="control-label col-xs-2" for="AxialRatio">O'Hara et al. (2006) def</label>
					<input type="text" size="12" maxlength="12" id="AxialRatio" name="AxialRatio"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="Ellipticity">Hashimoto et al. (2007) def</label>
					<input type="text" size="12" maxlength="12" id="Ellipticity" name="Ellipticity"><br />
				</div>
				<div class="form-group">
					<label class="control-label col-xs-2" for="Asymmetry">Hashimoto et al. (2007) def</label>
